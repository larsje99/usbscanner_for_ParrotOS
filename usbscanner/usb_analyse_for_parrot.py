def main():
    ...
    image_making_confirm = input("DO YOU WANT TO CREATE AN IMAGE OF THE CONNECTED DRIVE? TYPE \'YES\' or \'NO\': ")
    
    if image_making_confirm == "NO":
        sys.exit()
    ...
    subprocess.run('sudo mount -o ro ewf_mount/' + mount_point_list[-1], ' logical_mount', shell=True)
    time.sleep(1)
