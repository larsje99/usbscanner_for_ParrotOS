...
7. RUN 'sudo mv usbscanner_for_ParrotOS/usbscanner/config/scalpel.conf /etc/scalpel' | *Replace default scalpel configuration file with provided configuration*
